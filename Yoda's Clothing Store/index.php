...
<!--slider down data-->
            ...
            <div style="height:auto; width:1050px; margin:auto;   border:0px solid #000000; background-color:#FFFFFF; ">
               ...
               <div style="height:30px; width:1050px; border:0px solid #000000; color:#269FB2; text-align:center; font-size:18px; background-color:#DAD8D8;border-radius:5px; margin-top:10px; "><p style="margin-left:20px; margin-top:5px;"><b> Anime at it's BEST!!!</b></p>  </div>   
             ...
             $rat="4.0";
			 $q=5;
			 $query="select * from product where pro_cat='unique' and Ratings>='$rat' and quantity>='$q'";
...
?>
			 ...
			 <table  align="center">
               ...
               <tr style="height:200px; width:820px">
     <div style="height:30px; width:1050px; border:0px solid #000000; color:#269FB2; text-align:center; font-size:18px; background-color:#DAD8D8;border-radius:5px; margin-top:10px; "><p style="margin-left:20px; margin-top:5px;"><b> KEYCHAINS</b></p>  </div>   
             ...
             $rat="4.0";
			 $q=5;
			 $query="select * from product where pro_cat='keychains' and Ratings>='$rat' and quantity>='$q'";
			 ...
			 <table align="center">
               ...
               <tr style="height:200px; width:820px">
			        <div style="height:30px; width:1050px; border:0px solid #000000; color:#269FB2; text-align:center; font-size:18px; background-color:#DAD8D8;border-radius:5px; margin-top:10px; "><p style="margin-left:20px; margin-top:5px;"><b> BAGS </b></p>  </div>   
  ...
  $rat="4.0";
  $q=5;
			 $query="select * from product where pro_cat='bags' and Ratings>='$rat' and quantity>='$q'";
...
?>
			 ...
			 <table  align="center">
               ...
               <tr style="height:200px; width:820px">
			        <div style="height:30px; width:1050px; border:0px solid #000000; color:#269FB2; text-align:center; font-size:18px; background-color:#DAD8D8;border-radius:5px; margin-top:10px; "><p style="margin-left:20px; margin-top:5px;"><b> T-shirts </b></p>  </div>   
  ...
  $rat="4.0";
  $q=5;
			 $query="select * from product where pro_cat='tshirts' and Ratings>='$rat' and quantity>='$q'";

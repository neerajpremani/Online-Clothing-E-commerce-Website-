<?php session_start();
$con=mysqli_connect("localhost","root","root","yodas_stuff");
?>
...
<title>Yoda's Store/Privacy-Policy</title>
...
$server=mysqli_query($con,"select * from static where page='Terms&Condition'");

...
<h4 Style="font-size:15pt;color:red; background-color:#7CE1D6;width:400px;"> Shipping Address</h4>
...
<div id="block2"  >
<!--<h4 style="margin-left:45em;"> Billing Address</h4>-->
<br><h4 style="margin-left:30em;">Date:  <span id="demo" style="margin-left:1em;"></span><script>document.getElementById("demo").innerHTML = Date();</script></h4>

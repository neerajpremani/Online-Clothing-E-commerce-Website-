...
mysqli_query($con,"update static set details ='" .($_POST['txt']). "' where static_id='".$_GET['id']."'");
...
<font style="font-family:Verdana, Geneva, sans-serif; color:#930;">
 <?php
			   ...
			   list($value)=mysqli_fetch_array(mysqli_query($con,"select details  from static where static_id='".$_GET['id']."'"));
